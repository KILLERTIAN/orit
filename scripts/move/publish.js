...
async function publish() {
  ...
  move
    .createObjectAndPublishPackage({
      ...
      // Use the address name that exists in Move.toml
      addressName: "orit",
      namedAddresses: {
        // Compile/publish modules under the publisher's account address
        orit: process.env.NEXT_MODULE_PUBLISHER_ACCOUNT_ADDRESS,
      },
      extraArguments: [
