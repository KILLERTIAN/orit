...
import TopTraders from "@/components/CopyTrading/TopTraders";
import TraderProfile from "@/components/CopyTrading/TraderProfile";
...
export default function CopyTradingPage() {
  ...
  const handleCopyTrades = (traderId: string) => {
    toast({
      title: "Copy Trading Started",
      description: `You are now copying trades from trader ${traderId}`,
    });
  };
        ...
        <div className="relative z-10 py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold text-center text-white mb-12 flex items-center justify-center gap-4 animate-fade-in">
              <Copy className="text-purple-400 animate-pulse" size={48} />
              Copy Trading
            </h1>

            <p className="text-xl text-gray-300 text-center mb-16 max-w-3xl mx-auto animate-fade-in animation-delay-200">
            ...
            {/* Features Section - Only show when not viewing profile */}
            {!selectedTraderId && (
              <>
                <div className="mt-16 mb-16">
                  <h2 className="text-3xl font-bold text-center text-white mb-12">Why Choose Our Copy Trading?</h2>
